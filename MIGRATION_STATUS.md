...
- Target/minimum NeoForge: `26.1.2.86`
...
- `build` succeeds and produces
  `build/libs/FarmersDelight-26.1.2-1.3.3-fix3.jar` and
  `build/libs/FarmersDelight-26.1.2-1.3.3-fix3_source.jar`.
...
- A repeatable NeoForge GameTest suite validates core recipe matching and
  ...
  organic-compost/rich-soil behavior. All six required tests (five Farmer's
...
- The skillet arm-pose enum extension is compatible with NeoForge 26.1.2.86's
